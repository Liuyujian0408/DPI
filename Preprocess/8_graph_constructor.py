...
class GraphDataset(object):
    ...
    def __init__(self, data_dir, data_df, dis_threshold=5.0, graph_type='', num_process=48, create=True):
...
if __name__ == '__main__':
    data_root = 'DPI_data'
    toy_dir = data_root
    toy_df = pd.read_csv("toy_examples.csv")
    toy_set = GraphDataset(toy_dir, toy_df, graph_type='Graph_E_cloudBind', create=True)
